...
class CausesControllerTest < ActionController::TestCase
  ...
  test "should create cause" do
    assert_difference('Cause.count') do
      post :create, cause: { approved: @cause.approved, author: @cause.author, content: @cause.content, country: @cause.country, day: @cause.day, holiday: @cause.holiday }
    end
  ...
  test "should update cause" do
    put :update, id: @cause, cause: { approved: @cause.approved, author: @cause.author, content: @cause.content, country: @cause.country, day: @cause.day, holiday: @cause.holiday }
    assert_redirected_to cause_path(assigns(:cause))
  end
